...
namespace MachineProblem3
{
    public partial class CroutsCalc : Form
    {
        ...
        private void btnCholeskys_clear_Click(object sender, EventArgs e)
        {
            textBox1.Text = "";
            textBox2.Text = "";
            textBox3.Text = "";
        ...
        private void btnCholeskys_back_Click(object sender, EventArgs e)
        {
            this.Close();
        }

        private void btnCholeskys_1st_Click_1(object sender, EventArgs e)
        {
            for (int i = 0; i < 3; i++)
            {
                for (int j = 0; j < 3; j++)
        ...
        private void btnCholeskys_solve_Click(object sender, EventArgs e)
        {
