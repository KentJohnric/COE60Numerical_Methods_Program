...
{
    public partial class RegulaFalsiUserControl : UserControl
    {
        int i = 0, count = 0, flag = 0;
        double error = 0.0001;
        double[] coeff = new double[10];
        double x0, x1, x2 = 0, t = 0;
        public RegulaFalsiUserControl()
        {
            InitializeComponent();
        }

        private void RegulaFalsiUserControl_Load(object sender, EventArgs e)
        {
